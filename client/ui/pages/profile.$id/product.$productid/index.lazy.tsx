  ...
  return (
    (profileProductSuccess || preview) && (
      <ProductsDetailsPageLayout preview={preview}>
        ...
        <div
          className={`w-full h-full flex flex-col gap-y-3 ${preview ? 'pt-[6rem]' : 'mt-[10rem] sm:mt-[14rem] md:mt-[10rem] pt-24 sm:pt-8 md:pt-10'}`}>
          <div className="w-11/12 lg:w-10/12 xl:w-8/12 mx-auto h-full flex flex-col mt-2">
            ...
            <div className="flex md:flex-row flex-col border-[0.1px] border-white/30 divide-y-2 md:divide-y-0 md:divide-x-2 divide-white/30">
              <div className="flex flex-col w-full md:w-8/12 divide-y-2 divide-white/30">
                <div
                  className="divide-y-2 divide-white/30 flex flex-col"
                  ref={titleRef}>
                  <div className="text-3xl p-5">{title}</div>
                  <div className="flex text-xl justify-between gap-x-6 divide-x-2 divide-white/30">
                    <div className="p-5">{price}</div>
                    <div className="w-full p-5">Akshay bhat</div>
              ...
              <div className="md:w-4/12 w-full">
                <div className="flex flex-col gap-y-4 p-8 items-center w-full">
                  <span className="w-full text-lg">Name a fair price</span>
        ...
        <motion.div
          ...
          <div
            ...
            <span className={`text-xl ${titleIsInView && 'hidden'}`}>10rs</span>
            <div
              className="text-lg py-2 px-4 border-white/30 hover:text-white/80 border-[0.1px] rounded-xl cursor-pointer"
              onClick={(e) => {
