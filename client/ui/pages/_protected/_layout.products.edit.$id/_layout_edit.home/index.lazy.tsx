                  ...
                  <div className="flex gap-x-4 items-center" key={collab.id}>
                    ...
                    <fieldset className="border-white/30 border-[0.1px] rounded-md p-2 focus-within:border-white">
                      <input
                        ...
                        {...register(`collabs.${index}.email`)}
                      />
                      {errors.collabs && errors.collabs[index]?.email && (
                        <legend className="text-red-400 text-sm">
                          {errors.collabs[index]?.email?.message}
                        </legend>
                      )}
                    </fieldset>
                    <fieldset className="border-white/30 border-[0.1px] rounded-md p-2 focus-within:border-white">
                      <input
                        className="text-lg bg-background text-white outline-none px-4"
                        {...register(`collabs.${index}.share`)}
                      />
                      {errors.collabs && errors.collabs[index]?.share && (
                        <legend className="text-red-400 text-sm">
                          {errors.collabs[index]?.share?.message}
                        </legend>
                      )}
                    </fieldset>
                    <IoTrashBin
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div className="flex gap-x-4">
              <input
                ...
                className=" bg-background text-white border-white/30 border-[0.1px] p-1 w-fit"
              />
              <div className="text-base">Allow customers to leave Reviews</div>
            </div>
            <div className="flex gap-x-4">
              <input
                type="checkbox"
                className=" bg-background text-white border-white/30 border-[0.1px] p-1 w-fit"
              />
              <div className="text-base">Show number of sales</div>
            </div>
          </div>
        </div>
