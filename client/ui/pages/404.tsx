...
const NotFoundPage = () => {
	...
	return (
		<div className="flex flex-col gap-y-10 fixed sm:ml-24 sm:pr-24 mt-[6rem] sm:mt-0 z-50 top-0 left-0 w-full h-full text-white items-center justify-center tracking-wider font-thin" onMouseMove={(e) => {
			...
			const normalized_width = (e.clientX - width_low) / (width_high - width_low)
			const percentage_width = Math.min(100, Math.max(0, normalized_width * 100))
				...
				<div className="eye-main font-thinner">
					<div className="eye">
						<div className="inner-eye">
							<div className="pupil" style={{ top: `${pupilPos.top}rem`, marginLeft: `${pupilPos.left}rem` }}>
							</div>
						</div>
					</div>
					<div className="eye">
